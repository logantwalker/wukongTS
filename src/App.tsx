...
import wukong_ts from "./engines/wukong_ts";
...
function App() {
    ...
    return (
        <div className="flex = justify-center">
            <div className="color-shift mt-10 mb-5 flex-col justify-center overflow-hidden rounded-sm border border-stone-500 bg-stone-100 p-2.5 align-middle text-stone-900 shadow-lg dark:border-stone-700 dark:bg-stone-800 dark:text-stone-300 ">
